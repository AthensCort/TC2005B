  ...
  const handleSaveEdit = () => {
    if (form.nombre && form.precio && form.stock && form.photo) {
      ...
      if (isEditing && form.id !== null) {
        const updatedProduct: Product = { // Explicitly type updatedProduct
          id: form.id,
          ...updatedProductBase,
        };
        ...
        const newProduct: Omit<Product, 'id'> = { // Explicitly type newProduct (without id)
          ...updatedProductBase,
        };
        const updatedProducts = [...product, { ...newProduct }]; // When adding, the ID will likely be generated by the backend
        setProduct(updatedProducts);
        setFilteredProducts(updatedProducts);
      }
      ...
      setShowModal(false);
      setIsEditing(false);
      setForm({ id: null, nombre: "", precio: "", stock: "", photo: "" }); // Limpia el formulario, incluyendo el id
    }
  };
  const handleAddNew = () => {
