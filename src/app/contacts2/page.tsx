    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <div>
            <label className="font-semibold text-purple-300" htmlFor="name">
              Name:
            </label>
            <input
              id="name"
              type="text"
              className="w-full p-2 rounded bg-[#2a2458] text-white placeholder-purple-300"
          ...
          <div>
            <label className="font-semibold text-purple-300" htmlFor="email">
              Email:
            </label>
            <input
              id="email"
          ...
          <div>
            <label className="font-semibold text-purple-300" htmlFor="phone">
              Phone:
            </label>
            <input
              id="phone"
        ...
        <div className="flex justify-between gap-4 mt-6">
          ...
          <button
            onClick={saveChanges} // Asegúrate de definir esta función
            className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded"
          >
            Save
          </button>
